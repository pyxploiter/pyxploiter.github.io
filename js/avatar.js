...
function setupScene(gltf) {
    ...
    target.position.set(-1, 1, 5);  // initial head location
    ...
    document.addEventListener('mousemove', (ev) => {
        ...
        plane.setFromNormalAndCoplanarPoint(planeNormal, avatar.position);
        raycaster.setFromCamera(coords, camera);
        raycaster.ray.intersectPlane(plane, intersectionPoint);
        target.position.set((intersectionPoint.x - 1)/2, (intersectionPoint.y+1.5)/2, 2);
    });
